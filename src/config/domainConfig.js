...
export const DOMAIN_FIELD_DEFS = {
  ...
  vendorRef: {
    label: 'Vendor',
    type: 'select',
    options: ['Global Edu Partners', 'Study Abroad Hub', 'Pacific Pathways'],
    grid: grid.half,
  },
  vendorName: {
    label: 'Vendor name',
...
export const DOMAIN_RESOURCES = {
  vendors: {
    ...
    requiredFields: ['vendorRef', 'instituteName'],
    sections: [
      {
  ...
  institutes: {
    ...
    requiredFields: ['vendorName', 'instituteName'],
    sections: [
      {
        title: 'Institute details',
        description: 'Vendor link, identity, and publishing.',
        fields: ['vendorName', 'instituteName', 'websiteUrl', 'instituteStatus', 'isPublished'],
      },
      {
        title: 'Location & services',
        description: 'Address and service offerings.',
    ...
    emptyForm: () => ({
      vendorName: '', instituteName: '', websiteUrl: '', instituteStatus: 'Active', isPublished: 'No',
      address: '', city: '', state: '', serviceType: '', contactEmail: '', contactPhone: '', notes: '',
    }),
  },
  students: {
    singular: 'Student',
